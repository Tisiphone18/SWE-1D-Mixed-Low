...
Writers::ConsoleWriter::ConsoleWriter(std::ostream& ostream):
  ostream_(ostream) {}

void Writers::ConsoleWriter::write(const RealType* h, const RealType* hu, unsigned int size) {
