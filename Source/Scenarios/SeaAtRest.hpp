...
namespace Scenarios {
  ...
  class SeaAtRest: public Scenario {
    /** Width of space to be simulated */
    const ComputeType width_;
    /** Number of cells */
    const unsigned int size_;
    /** Initial height */
    const ComputeType h_;
  ...
  public:
     ...
     */
    SeaAtRest(ComputeType width, unsigned int size, ComputeType h);
    ~SeaAtRest() override = default;

    /**
    * @return Cell size of one cell (= domain size/number of cells)
    */
    ComputeType getCellSize() const override;

    /**
     * @return Initial water height at pos
     */
    ComputeType getHeight(unsigned int pos) const override;

    /**
     * @return Initial momentum of water (hu) at position pos
     */
    ComputeType getMomentum(unsigned int pos) const override;

    /**
     * @return Bathymetry (b) at position pos
     */
    ComputeType getBathymetry(unsigned int pos) const override;
  };
